                ...
                <div class="basic-form">
                    <form method="POST" action="#" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" required="yes" disabled value="<?php echo $form_view['exam_score'] ?>" name="payment_date">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label"><strong> Admission Decision</strong></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" required="yes" disabled value="<?php if($form_view['admission_status'] == 11){echo 'Successful';}else{echo 'Denied';}?>" name="payment_date">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="button" name="action" onclick="PrintElem('#myDiv')" class="btn btn-primary">Print Admission Decision</button>
                            </div>
                        </div>
                    </form>
                </div>
