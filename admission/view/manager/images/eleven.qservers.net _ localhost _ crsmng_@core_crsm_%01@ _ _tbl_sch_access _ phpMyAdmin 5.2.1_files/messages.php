...
<head>
    ...
    <link href="/cPanel_magic_revision_1676511843/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1520002529/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
...
<input type="hidden" id="goto_uri" value="/3rdparty/phpMyAdmin/js/messages.php?l=en_GB&amp;v=5.2.1&amp;lang=en_GB" />
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1520002529/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1520002530/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
...
<style>
    ...
    <div class="copyright">Copyright© 2023 cPanel, L.L.C.
